...
namespace BitSharp.Core.Monitor
{
    ...
    {
        public virtual void BeginBlock(ChainedBlock block) { }
        ...
        public virtual void CommitBlock(ChainedBlock block) { }

        public virtual void RollbackBlock(ChainedBlock block) { }
    }
}
