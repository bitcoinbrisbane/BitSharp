...
namespace BitSharp.Blockchain
{
    public interface IBlockchainRules
    {
        ...
        void ValidateBlock(Block block, Data.Blockchain blockchain, Utxo utxo, ImmutableDictionary<UInt256, ImmutableHashSet<int>> newTransactions /*, ImmutableDictionary<UInt256, Transaction> transactions*/);
