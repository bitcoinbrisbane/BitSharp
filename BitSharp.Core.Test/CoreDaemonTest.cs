    ...
    public class CoreDaemonTest
    {
        ...
        public void TestAddSingleBlock()
        {
            using (var daemon = new TestDaemon())
            {
                ...
                daemon.WaitForDaemon(expectedHeight: 1);
        ...
        public void TestLongBlockchain()
        {
            using (var daemon = new TestDaemon())
            {
                ...
                daemon.WaitForDaemon(expectedHeight: height);
        ...
        public void TestSimpleSpend()
        {
            using (var daemon = new TestDaemon())
            {
                ...
                // check
                daemon.WaitForDaemon(expectedHeight: 2);
                ...
                // check
                daemon.WaitForDaemon(expectedHeight: 3);
                ...
                // check
                daemon.WaitForDaemon(expectedHeight: 4);
        ...
        public void TestSimpleBlockchainSplit()
        {
            using (var daemon1 = new TestDaemon())
            {
                ...
                daemon1.WaitForDaemon(expectedHeight: 3);
                ...
                // wait for daemon
                daemon1.WaitForDaemon(expectedHeight: 4);
                ...
                daemon1.WaitForDaemon(expectedHeight: 5);
                ...
                daemon1.WaitForDaemon(expectedHeight: 6);
                ...
                using (var daemon2 = new TestDaemon(daemon1.GenesisBlock))
                {
                    ...
                    daemon2.WaitForDaemon(expectedHeight: 6);
        ...
        public void TestShorterChainWins()
        {
            using (var daemon = new TestDaemon())
            {
                ...
                // check
                daemon.WaitForDaemon(expectedHeight: 5);
        ...
        [TestMethod]
        public void TestTargetIssue()
        {
            var txManager = new TransactionManager(LogManager.CreateNullLogger());

            // create a new keypair to spend to
            var toKeyPair = txManager.CreateKeyPair();
            var toPrivateKey = toKeyPair.Item1;
            var toPublicKey = toKeyPair.Item2;

            // create a new keypair to double spend to
            var toKeyPairBad = txManager.CreateKeyPair();
            var toPrivateKeyBad = toKeyPair.Item1;
            var toPublicKeyBad = toKeyPair.Item2;
            ...
            for (var i = 0; i < 1.THOUSAND(); i++)
            {
                ...
                using (var daemon = new TestDaemon())
                {
                    ...
                    daemon.CoreDaemon.ForceWorkAndWait();

                    var invalid = daemon.CoreStorage.IsBlockInvalid(block4Bad.Hash);
                    var x = daemon.CoreDaemon.TargetBlock.Height;
                    var y = daemon.CoreDaemon.TargetChain.Height;
                    var z = daemon.CoreDaemon.CurrentChain.Height;
                    Debug.WriteLine("----------");
