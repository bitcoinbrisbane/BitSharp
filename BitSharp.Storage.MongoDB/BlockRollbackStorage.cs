...
{
    public class BlockRollbackStorage : MongoDBDataStorage<IImmutableList<KeyValuePair<UInt256, UInt256>>>
    {
        public BlockRollbackStorage(MongoDBStorageContext storageContext)
